        ...
        <div class="container-lg">
          ...
          <div class="collapse navbar-collapse flex-row justify-content-end" id="nav" >
            <ul class="nav nav-pills pt-2 ">
                <li class="nav-item"><a href="#" class="nav-link btn bg-primary text-white">Home</a> </li>
                <li class="nav-item"><a href="#scrollspyHeading1" class="nav-link ">About</a> </li>
                <li class="nav-item"><a href="#scrollspyHeading2" class="nav-link " id="list-1">Product</a> </li>
                <li class="nav-item"><a href="#scrollspyHeading3" class="nav-link " id="list-2">Service</a> </li>
                <li class="nav-item"><a href="#scrollspyHeading4" class="nav-link ">Contact</a> </li>
